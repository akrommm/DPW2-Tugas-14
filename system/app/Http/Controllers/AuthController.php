...
class AuthController extends Controller
{
    ...
    function loginProcess()
    {
        ...
        //     $user = Auth::user();
        //     if ($user->level == 1) return redirect('beranda/penjual')->with('success', 'Mantap Bise Login bree!!');
        //     if ($user->level == 0) return redirect('beranda/pembeli')->with('success', 'Mantap Bise Login bree!!');
        // } else {
